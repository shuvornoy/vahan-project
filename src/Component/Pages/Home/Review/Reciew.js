    ...
    return (
      <div className="my-14 w-full mx-auto">
        <div className="text-center xl:text-[52px] xl:leading-[60px] text-3xl mb-16 ">
          ...
          <div className="bg-[#F36E21] xl:w-[244px] w-[90px] xl:h-[12px] h-[8px] text-center absolute xl:ml-[916px] lg:ml-[608px] md:ml-[480px] ml-[115px] xl:mt-[-16px] mt-[-11px]"></div>
        </div>
        <div className="lg:flex block items-center xl:gap-20 gap-8 lg:px-0 md:px-8 px-4 lg:overflow-hidden xl:h-[380px] lg:h-[240px]">
          <div className="shadow-2xl xl:w-[845px] lg:w-[640px] w-full p-8 xl:h-[240px] lg:h-[200px] md:h-[180px] h-full text-center relative opacity-100 xl:ml-[-355px] lg:ml-[-450px] ">
          ...
          <div className="shadow-2xl xl:w-[845px] lg:w-[640px] w-full p-8 xl:h-[240px] lg:h-[200px] md:h-[180px] h-full text-center relative opacity-100 xl:mr-[-420px] mr-[-480px]">
            <p className="text-[16px] font-medium interReg xl:mt-10">
              Lorem Ipsum has been the industry's standard dummy text ever since
              the 1500s, when an unknown printer took a galley of type and
              scrambled it to make a type specimen book. It has survived not
