...
const LandingPage = () => {
    return (
      <div className="max-container">
        <div>
          <div className=" h-[100vh] w-[100%] absolute img-gradient bg-black LandingPage cover-img">
            <img
          ...
          <div className="text-center relative text-white xl:top-[450px] lg:top-[340p] md:top-[450px] top-[300px] ">
